...
path = "E:/PycharmProjects/InstaAutomator-master/posts/"
                ...
                if todays_date.hour == POST_HOUR:
                    ...
                    if not post.has_been_posted: 
                        with client(USERNAME, PASSWORD) as cli:
                            cli.upload("E:/PycharmProjects/InstaAutomator-master/production_ready_posts/" + post.image, post.description)
